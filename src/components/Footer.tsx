      ...
      <div className="container py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Rewarding eco-friendly behavior with real crypto incentives on Solana.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/actions" className="text-muted-foreground hover:text-foreground transition-colors">
                  Eco Actions
                </Link>
              </li>
              <li>
        ...
        <div className="mt-10 pt-6 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Green Stake DAO. All rights reserved.
          </p>
